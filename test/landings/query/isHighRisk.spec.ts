...
describe('isSpeciesFailure', () => {

  describe('when validing against an landing dec or catch recording', () => {
    let mockIsHighRisk;
    ...
    describe('when the landing is a species mis-match', () => {
      ...
      it('should return true when species toggle is disabled', () => {
        ...
        const result = SUT.isSpeciesFailure(mockIsHighRisk)(mockIsRiskEnabled(), isSpeciesExists, mockGetTotalRiskScore());
