...
export function toSdProduct(validatedSdProducts: ISdPsQueryResult): IDynamicsStorageDocumentProduct {
  ...
  return {
    ...
    netWeightProductArrival: parseInt(validatedSdProducts.netWeightProductArrival, 10),
    netWeightFisheryProductArrival: parseInt(validatedSdProducts.netWeightFisheryProductArrival, 10),
    netWeightProductDeparture: parseInt(validatedSdProducts.netWeightProductDeparture, 10),
    netWeightFisheryProductDeparture: parseInt(validatedSdProducts.netWeightFisheryProductDeparture, 10),
    validation: {
